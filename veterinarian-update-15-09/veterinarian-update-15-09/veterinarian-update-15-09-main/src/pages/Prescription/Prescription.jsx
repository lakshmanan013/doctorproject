              ...
              <table className="rx-med-table">
                ...
                <tbody>
                  {medicines.filter(m => m.medicineId || m.dosage).map((m, i) => {
                    const med = allMeds.find(x => String(x.id) === String(m.medicineId)); return (
                      <tr key={m.id}>
                        <td>
